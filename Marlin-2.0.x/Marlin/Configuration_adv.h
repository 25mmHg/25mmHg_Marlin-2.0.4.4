 ...
 **/
  ...
  #define THERMAL_PROTECTION_PERIOD 20        // @25mmHgFIX: Seconds
...
//
  ...
  #define TFT_MARLINUI_COLOR 0x07FF // Bright Cyan
  #define TFT_MARLINBG_COLOR 0x0000 // Black
  #define TFT_DISABLED_COLOR 0x0000 // Black
  #define TFT_BTCANCEL_COLOR 0xF800 // Red
  #define TFT_BTARROWS_COLOR 0x07FF // Bright Cyan
  #define TFT_BTOKMENU_COLOR 0xF800 // Red
#endif
...
#if ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 32 //@25mmHgFIX: SD,LCD,Buttons take more memory, block buffer needs to be smaller
#else
...
#define GCODE_CASE_INSENSITIVE  //@25mmHgFIX: Accept G-code sent to the firmware in lowercase
